#This is the updated version of test.py to run mongo inside Docker. It has been tested to work, even when MongoDB has been uninstalled from the host system and is only present inside Docker.
#Original Header:
...
#make sure we have a mongo docker container running Mongo
call(["sh", "./docker-mongo-integration.sh"])
